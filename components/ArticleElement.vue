...
<script>
export default {
  props: ["parentRef", "title"],
  mounted: function() {},
  methods: {
    alert: function() {
      console.log(typeof this.observer);
      console.log(typeof this.observer.observe);
    },
    setWatcher() {
      let options = {
        root: this.parentRef,
      ...
      let callback = (changes, observer) => {
        changes.forEach(change => {
          console.log(this.title,change.intersectionRatio,change.isIntersecting);
        //   console.log(change);
        //   console.log(change.intersectionRatio);
        //   console.log(change.isIntersecting);
          if (change.isIntersecting == true) {
            console.log(this.title + " is activated");
